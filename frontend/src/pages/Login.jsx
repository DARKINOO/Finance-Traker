      ...
      <div className="container mx-auto px-4 py-8 md:py-12 min-h-screen flex items-center justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 w-full max-w-6xl">
          ...
          <div className="flex flex-col justify-center space-y-6 p-4 md:p-8 order-2 lg:order-1">
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                Track your finances with AI-powered insights and beautiful visualizations
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              <div className="backdrop-blur-sm border border-pink-400/10 rounded-lg p-4 md:p-6 shadow-lg shadow-cyan-400/5 
                ...
                <div className="text-xl md:text-2xl font-bold text-pink-500 mb-2">Smart AI</div>
                <p className="text-gray-400 text-sm md:text-base">Intelligent predictions and category suggestions</p>
              </div>
              <div className="backdrop-blur-sm border border-cyan-400/10 rounded-lg p-4 md:p-6 shadow-lg shadow-pink-400/5
                          transform hover:scale-105 transition-transform duration-300">
                <div className="text-xl md:text-2xl font-bold text-cyan-400 mb-2">Analytics</div>
                <p className="text-gray-400 text-sm md:text-base">Beautiful charts and visual insights</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative backdrop-blur-sm border border-pink-400/10 shadow-lg shadow-cyan-400/5 rounded-lg 
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6 md:mb-8 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-cyan-400">
              Finance Project Login
            </h1>
            {error && (
              <div className="mb-4 md:mb-6 p-3 md:p-4 text-sm md:text-base text-red-400 bg-red-900/50 rounded-lg border border-red-500/20" role="alert">
                {error}
              </div>
            )}
            ...
            <div className="mt-6 text-center space-y-3">
              <p className="text-gray-400 text-sm md:text-base">
                ...
                <a href="/signup" className="text-pink-500 hover:text-pink-400 transition-colors duration-200 font-medium">
                  Sign up
                </a>
              </p>
              <p className="text-gray-400 text-sm md:text-base">
                <a href="/forgot-password" className="text-pink-500 hover:text-pink-400 transition-colors duration-200 font-medium">
